        ...
        <div className="navbar-collapse collapse" id="navbarSupportedContent">
          <ul className="navbar-nav  mb-2 mb-lg-0">
            ...
            <a
              ...
              <ul className="dropdown-menu" aria-labelledby="navbar-dropdown-link">
                <li>
                    <Nav.Link className="dropdown-item" as={Link} to="/infoclient"><strong>Votre compte</strong>
                    </Nav.Link>
                </li>
              </ul>
            </li>)}
            {/* --- * --- * --- * Magasin * --- * --- */}
            <li className="nav-item">
              <Nav.Link as={Link} to="/magasin">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Magasin</strong></Nav.Link>
            </li>
            {/* --- * --- * --- * Panier * --- * --- */}
            { etatpanier && (
            <li className="nav-item dropdown">
              <a
                ...
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                  width="24px" height="24px" viewBox="0 0 1280.000000 1225.000000"
              ...
              <ul className="dropdown-menu" aria-labelledby="navbar-dropdown-link">
                <li>
                    <Nav.Link className="dropdown-item" as={Link} to="/panier"><strong>Voir le panier</strong>
                    </Nav.Link>
                </li>
              </ul>
            </li>)}
            ...
            <li className="nav-item dropdown">
              <a
                ...
                aria-expanded="false"
                data-bs-auto-close="outside"
                >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>BackOffice Produits</strong>
              </a>
              <ul className="dropdown-menu" aria-labelledby="navbar-dropdown-link">
                {/* ---  ---  --- * Cuvées * --- --- */}
                <li className="dropdown dropend">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbar-dropdown-link">
                    <li>
                      <Nav.Link className="dropdown-item" as={Link} to="/nouvcuvee">
                      <strong>Nouvelle cuvée</strong></Nav.Link>
                    </li>
                    <li>
                      <Nav.Link className="dropdown-item" as={Link} to="/desccuvee">
                      <strong>Descriptions des cuvées</strong></Nav.Link>
                    </li>
                  </ul>
                </li>
                {/* ---  ---  --- * Bouteilles * --- --- */}
                <li className="dropdown dropend">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbar-dropdown-link">
                    <li>
                      <Nav.Link className="dropdown-item" as={Link} to="/descbouteille">
                      <strong>Bouteilles, Images, Produits, Stock</strong></Nav.Link>
                    </li>
                  </ul>
                </li>
                {/* ---  ---  --- * Produits * --- --- */}
                <li className="dropdown dropend">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbar-dropdown-link">
                    <li>
                      <Nav.Link className="dropdown-item" as={Link} to="/nouvproduit">
                      <strong>Nouveau produit</strong></Nav.Link>
                    </li>
                    <li>
                      <Nav.Link className="dropdown-item" as={Link} to="/listproduit">
                      <strong>Liste des produits</strong></Nav.Link>
                    </li>
                  </ul>
                </li>
                <li>
                  <Nav.Link className="dropdown-item" as={Link} to="/majstock">
                  <strong>Mise à jour du stock</strong></Nav.Link>
                </li>
              </ul>
            </li>)}
          </ul>
...
/** original
  return (
    <Navbar  classNameName="bg-primary-subtle">
      <Container>
        <Navbar.Brand as={Link} to="/">
          Seigneur des Anneaux | connecté ? {authContext.user.status}
        </Navbar.Brand>
