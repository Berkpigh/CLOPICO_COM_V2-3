...
{/* --- * --- * --- * Votre Compte * --- * --- */}
            ...
            authContext.role.role != "hôte") && (
              ...
              <NavDropdown  className={`${styles.myTitleFont} 
                ...
                <NavDropdown.Item as={Link} to="/infoclient">
...
{/* --- * --- * --- * Panier * --- * --- */}
            { etatpanier && (
              <NavDropdown className={`${styles.myTitleFont} 
                ...
                <NavDropdown.Item as={Link} to="/panier">
...
{/* ---  ---  --- * Cuvées * --- --- */}
                  ...
                  <NavDropdown.Item as={Link} to="/desccuvee">
                      <strong>Descriptions des cuvées</strong>
                  </NavDropdown.Item>
                </NavDropdown>
{/* ---  ---  --- * Bouteilles * --- --- */}
                <NavDropdown className={`${styles.myTitleFont} 
...
{/* ---  ---  --- * Produits * --- --- */}
                <NavDropdown className={`${styles.myTitleFont} 
                  ...
                  <NavDropdown.Item as={Link} to="/listproduit">
                      <strong>Liste des produits</strong>
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/majstock">
                    <strong>Mise à jour du stock</strong>
                  </NavDropdown.Item>
              </NavDropdown>
            </NavDropdown>)}
          </Nav>
