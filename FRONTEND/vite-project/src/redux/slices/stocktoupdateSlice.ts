...
export interface BouteilleStock {
    value: {
        bouteilleId: number,
        cuvéeId: number,
...
const initialState: BouteilleStock = {
    value: {
        bouteilleId: 0,
        cuvéeId: 0,
        libelléBouteille: "",
...
const stocktoupdateSlice = createSlice({
    name: "stocktoupdate",
    initialState,
    reducers: {
        storestockinitial: (state) => {
...
export const { storestockinitial, storestock } = stocktoupdateSlice.actions;
export default stocktoupdateSlice.reducer;